...
const AboutUs = () => {
    return (
        <div>
        <h1>About Us</h1>
        <p>Welcome to our barbershop! We are a locally owned and operated business that has been serving the community for over 10 years. Our team of experienced barbers specialize in a variety of cuts and styles for men, women, and children. We pride ourselves on providing excellent customer service and a comfortable, relaxed atmosphere for our clients.</p>
